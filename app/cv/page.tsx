        ...
        <header className="border border-border p-6">
          ...
          <div className="mt-4 grid gap-3 text-sm sm:grid-cols-3">
            <div>
              ...
              <div>
                <a className="text-foreground underline" href="mailto:mikko.kohtala@knowit.fi">
                  mikko@mbit.fi
                </a>
              </div>
            </div>
            <div>
              ...
              <div>
                <a className="text-foreground underline" href="tel:+358408291001">
                  +358 40 829 1001
                </a>
              </div>
            </div>
        ...
        <section>
          ...
          <div className="space-y-4 border border-border p-6 leading-relaxed text-muted-foreground">
            <p>
              ...
              services, IoT systems, virtual event platforms, and financial applications.
            </p>
            <p>
              He is comfortable contributing from early planning through to production, collaborating on solutions that
              are practical, scalable, and user-friendly. His technical foundation includes cloud platforms like AWS and
              GCP, and modern web technologies such as TypeScript, React, Node.js, and Next.js.
            </p>
            <p>
              Most recently, Mikko has been heavily focused on AI and generative AI development. He leverages
              AI-assisted development tools including Cursor, Claude Code, GitHub Copilot, and Codex, works extensively
              with LLMs from OpenAI, Google, and Anthropic, and utilizes AI platforms such as ChatGPT, Gemini, Vertex
              AI, v0, and Lovable to deliver modern, AI-enhanced solutions.
            </p>
            <p>
              Mikko is dedicated to continuous learning and enjoys solving real-world problems by building thoughtful
              and robust software.
            </p>
          </div>
        </section>
        ...
        <section>
          ...
          <div className="border border-border p-6">
            <ul className="space-y-2 text-sm">
              <li className="before:mr-2 before:text-accent before:content-['→']">Finnish - Native</li>
              <li className="before:mr-2 before:text-accent before:content-['→']">English - Advanced</li>
            </ul>
          </div>
        </section>
          ...
          <div className="space-y-6">
            <article className="border border-border p-6">
              ...
              <ul className="mt-4 space-y-2 text-sm text-muted-foreground">
                ...
                <li className="before:mr-2 before:text-accent before:content-['→']">
                  Delivering training and enablement programs for leadership, product, and engineering teams on
                  AI-assisted development.
                </li>
                <li className="before:mr-2 before:text-accent before:content-['→']">
                  Architecting custom AI agents and assistants for workflows including code review, testing, compliance,
                  and product management.
                </li>
                <li className="before:mr-2 before:text-accent before:content-['→']">
                  Supporting legacy system modernization and cloud-native infrastructure preparation for AI readiness.
                </li>
              </ul>
            </article>
            ...
            <article className="border border-border p-6">
              ...
              <ul className="mt-4 space-y-2 text-sm text-muted-foreground">
                ...
                <li className="before:mr-2 before:text-accent before:content-['→']">
                  Member of the AI Ambassador program, driving AI adoption and evangelizing AI best practices across the
                  organization.
                </li>
                <li className="before:mr-2 before:text-accent before:content-['→']">
                  Part of the code competence team, developing and promoting improved engineering practices and ways of
                  working.
                </li>
              </ul>
            </article>
            ...
            <article className="border border-border p-6">
              ...
              <ul className="mt-4 space-y-2 text-sm text-muted-foreground">
                ...
                <li className="before:mr-2 before:text-accent before:content-['→']">
                  Owned end-to-end delivery of high-SLA services with secure, reliable announcement distribution.
                </li>
              </ul>
            </article>
            ...
            <article className="border border-border p-6">
              ...
              <ul className="mt-4 space-y-2 text-sm text-muted-foreground">
                ...
                <li className="before:mr-2 before:text-accent before:content-['→']">
                  Delivered APIs enabling elevator data retrieval, elevator control, and robot integrations.
                </li>
              </ul>
            </article>
            ...
            <article className="border border-border p-6">
              ...
              <ul className="mt-4 space-y-2 text-sm text-muted-foreground">
                ...
                <li className="before:mr-2 before:text-accent before:content-['→']">
                  Contributed to the rewrite of the train conductor Android application and supporting backend services.
                </li>
              </ul>
            </article>
            ...
            <article className="border border-border p-6">
              ...
              <ul className="mt-4 space-y-2 text-sm text-muted-foreground">
                ...
                <li className="before:mr-2 before:text-accent before:content-['→']">
                  Ticker - Insider list management software automating MAR-compliant workflows.
                </li>
                <li className="before:mr-2 before:text-accent before:content-['→']">
                  Timber - Mobile quality manual empowering sawmill companies to manage and share product imagery.
                </li>
                <li className="before:mr-2 before:text-accent before:content-['→']">
                  Sidonnaisuusrekisteri - Digital liability register helping Finnish councils meet Municipality Act
                  requirements.
                </li>
              </ul>
            </article>
          ...
          <div className="grid gap-6 sm:grid-cols-2">
            <article className="border border-border p-6">
              ...
              <ul className="space-y-2 text-sm text-muted-foreground">
                ...
                <li className="before:mr-2 before:text-accent before:content-['→']">Rust, hobby</li>
                <li className="before:mr-2 before:text-accent before:content-['→']">Kotlin</li>
              </ul>
            </article>
            ...
            <article className="border border-border p-6">
              ...
              <ul className="space-y-2 text-sm text-muted-foreground">
                ...
                <li className="before:mr-2 before:text-accent before:content-['→']">Tailwind CSS</li>
              </ul>
            </article>
            ...
            <article className="border border-border p-6">
              ...
              <ul className="space-y-2 text-sm text-muted-foreground">
                ...
                <li className="before:mr-2 before:text-accent before:content-['→']">
                  Full-stack AI development with Vercel, Convex, Node.js, TypeScript, Next.js and React
                </li>
              </ul>
            </article>
            ...
            <article className="border border-border p-6">
              ...
              <ul className="space-y-2 text-sm text-muted-foreground">
                ...
                <li className="before:mr-2 before:text-accent before:content-['→']">REST APIs</li>
              </ul>
            </article>
            ...
            <article className="border border-border p-6">
              ...
              <ul className="space-y-2 text-sm text-muted-foreground">
                ...
                <li className="before:mr-2 before:text-accent before:content-['→']">Serverless Computing</li>
                <li className="before:mr-2 before:text-accent before:content-['→']">Docker</li>
                <li className="before:mr-2 before:text-accent before:content-['→']">Kubernetes</li>
                <li className="before:mr-2 before:text-accent before:content-['→']">Terraform</li>
              </ul>
            </article>
            ...
            <article className="border border-border p-6">
              ...
              <ul className="space-y-2 text-sm text-muted-foreground">
                ...
                <li className="before:mr-2 before:text-accent before:content-['→']">Linux</li>
              </ul>
            </article>
            ...
            <article className="border border-border p-6">
              ...
              <ul className="space-y-2 text-sm text-muted-foreground">
                ...
                <li className="before:mr-2 before:text-accent before:content-['→']">IoT Systems</li>
                <li className="before:mr-2 before:text-accent before:content-['→']">Testing & Quality Assurance</li>
              </ul>
            </article>
          </div>
        </section>
